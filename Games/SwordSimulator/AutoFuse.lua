...
local Success,Colors = pcall(loadstring(game:HttpGet("https://raw.githubusercontent.com/DoComplement/Roblox/main/Colors/ColorPicks.lua")));
assert(Success and pcall(loadstring(game:HttpGet("https://raw.githubusercontent.com/DoComplement/Roblox/main/Library/TableToString/t2s_v2.lua", "nil return from HttpGet"))), "Error loading http-script");
Success = nil;
...
Main[5][18] = function(ItemButton, Index, List)
	...
	Objects.Item = CreateInstance("TextButton", {Name = "Item", Parent = Objects.ItemFrame, BackgroundColor3 = Color3.new(unpack(Colors[math.random(1, 154)])), BorderSizePixel = 0, Position = UDim2.new(0, 0, -0.002, 0), Size = UDim2.new(0, 190, 0, 30), ZIndex = 2, Font = Enum.Font.GothamMedium, Text = ItemButton.Text, TextColor3 = Color3.fromHex("ffffff"), TextSize = 13.000, TextWrapped = true});
