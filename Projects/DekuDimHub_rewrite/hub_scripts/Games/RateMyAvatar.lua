-- "https://raw.githubusercontent.com/1201for/V.G-Hub-Part-3/main/RateMyAvatar"

if(not game:IsLoaded())then game.Loaded:Wait()end;
if(game.PlaceId~=6708206173 or nil~=getgenv()["~`VVKOb]#DpOTIzB-tOZz44+]V90bj.:"])then return end;
getgenv()["~`VVKOb]#DpOTIzB-tOZz44+]V90bj.:"] = true;
...
local Toggle1 = Section1:CreateToggle("Random Rate All", Settings.Random, function(State)
Settings.Random = State
spawn(
    function()
        while wait() and Settings.Random do
            pcall(
                function()
                    for i, v in pairs(game:GetService("Players"):GetChildren()) do
                        if v ~= game:GetService("Players").LocalPlayer then
                            ...
                            game:GetService("ReplicatedStorage").PostRating:FireServer(v, math.random(1, 5))
                        end
                    end
                end
            )
...
local Toggle1 = Section1:CreateToggle("Rate All", Settings.R, function(State)
Settings.R = State
spawn(
    function()
        while wait() and Settings.R do
            pcall(
                function()
                    for i, v in pairs(game:GetService("Players"):GetChildren()) do
                        if v ~= game:GetService("Players").LocalPlayer then
                            ...
                            game:GetService("ReplicatedStorage").PostRating:FireServer(v, Settings.Amount)
                        end
                    end
                end
            )
...
Section1:CreateTextBox("Rate Person", "UserName Here", false, function(String)
...
local Slider3 = Section1:CreateSlider("Rate Amount",0,5,Settings.Amount,false, function(Value)
...
Section1:CreateTextBox("Teleport To Player", "UserName Here", false, function(String)
