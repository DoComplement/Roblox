-- "https://raw.githubusercontent.com/1201for/V.G-Hub-Part-3/main/A-Heros-Era-OfSomethingelseYT"

if(not game:IsLoaded())then game.Loaded:Wait()end;
if(game.PlaceId~=9840387028 or nil~=getgenv()[":oxX&[emoOnp_&jx.*ziP^t^oV7#da#c"])then return end;
getgenv()[":oxX&[emoOnp_&jx.*ziP^t^oV7#da#c"] = true;
