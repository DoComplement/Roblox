-- "https://raw.githubusercontent.com/1201for/V.G-Hub/main/Shoot-Out"

if(not game:IsLoaded())then game.Loaded:Wait()end;
if(game.PlaceId~=4738545896 or nil~=getgenv()["ZAUZn]BHi-YkZ?L$l!Pyv~Y=+VSC)?.)"])then return end;
getgenv()["ZAUZn]BHi-YkZ?L$l!Pyv~Y=+VSC)?.)"] = true;
