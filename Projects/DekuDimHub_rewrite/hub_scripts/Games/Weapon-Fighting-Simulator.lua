-- "https://raw.githubusercontent.com/1201for/V.G-Hub-Part-3/main/Weapon-Fighting-Simulator"

if(not game:IsLoaded())then game.Loaded:Wait()end;
if(game.PlaceId~=8554378337 or nil~=getgenv()["5n?c$iRm1_4emAGOF;nU*K;Q)k]eYHV+"])then return end;
getgenv()["5n?c$iRm1_4emAGOF;nU*K;Q)k]eYHV+"] = true;
...
local function GetClosestBitch()
...
local Tab1 = Window:CreateTab("Weapon Fighting Simulator")
...
getgenv().Okthen = State

while wait() and getgenv().Okthen do
    pcall(
        function()
            workspace.Fight.Events.FightAttack:InvokeServer(0, GetClosestBitch().Name)
