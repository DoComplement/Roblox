-- "https://raw.githubusercontent.com/1201for/V.G-Hub/main/Buildaboat"

if(not game:IsLoaded())then game.Loaded:Wait()end;
if(game.PlaceId~=537413528 or nil~=getgenv()["Cw]nvJJ~(ERv!39cIRcJyQn+zuQlrQOB"])then return end;
getgenv()["Cw]nvJJ~(ERv!39cIRcJyQn+zuQlrQOB"] = true;
