-- "https://raw.githubusercontent.com/1201for/V.G-Hub/main/ragdollengine"

if(not game:IsLoaded())then game.Loaded:Wait()end;
if(game.PlaceId~=8892207911 or nil~=getgenv()["NFx8j?XOySk&]h9qsIWYR4m`.)n+7SDg"])then return end;
getgenv()["NFx8j?XOySk&]h9qsIWYR4m`.)n+7SDg"] = true;
...
local Tab1 = Window:CreateTab("Ragdoll Engine")
...
local Toggle1 = Section1:CreateToggle("AntiRagDoll", Settings.AntiRagDoll, function(State)
Settings.AntiRagDoll = State
spawn(
    function()
        while wait() and Settings.AntiRagDoll do
            for i, v in pairs(game.Players.LocalPlayer.Character:GetChildren()) do
                if v.Name ~= "Animate" and v:IsA("LocalScript") then
                    v.Disabled = true
                elseif not Settings.AntiRagDoll and v.Name ~= "Animate" and v:IsA("LocalScript") then
                    v.Disabled = false
                end
            end
        end
