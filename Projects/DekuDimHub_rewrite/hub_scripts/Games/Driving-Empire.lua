-- "https://raw.githubusercontent.com/1201for/V.G-Hub-Part-3/main/Driving-Empire"

if(not game:IsLoaded())then game.Loaded:Wait()end;
if(game.PlaceId~=3351674303 or nil~=getgenv()["=pIdXpuW`$9NFEK.s=yz!ZtIz(9xFCV?"])then return end;
getgenv()["=pIdXpuW`$9NFEK.s=yz!ZtIz(9xFCV?"] = true;
        ...
        while wait() and Settings.Speed do
            ...
            pcall(
                function()
                  ...
                  ReturnCar():SetPrimaryPartCFrame(CFrame.new(-1179, 19, -2964))
                end
            )
        end
    end
...
Section3:CreateLabel("Credits Haze")
