-- "https://raw.githubusercontent.com/1201for/V.G-Hub/main/TSUNAMI-SURVIVAL"

if(not game:IsLoaded())then game.Loaded:Wait()end;
if(game.PlaceId~=3268556893 or nil~=getgenv()["uZ_^?=4@8?imP`*QFAluPq&AO+S;kZrs"])then return end;
getgenv()["uZ_^?=4@8?imP`*QFAluPq&AO+S;kZrs"] = true;
...
local Tab1 = Window:CreateTab("TSUNAMI SURVIVAL")
...
if oc then
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-201.928864, 136.033707, -88.0325928)
end end)
