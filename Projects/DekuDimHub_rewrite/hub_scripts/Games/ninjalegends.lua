-- "https://raw.githubusercontent.com/1201for/V.G-Hub/main/ninjalegends"

if(not game:IsLoaded())then game.Loaded:Wait()end;
if(game.PlaceId~=3956818381 or nil~=getgenv()["DS=yp*:$Ak5Nz5fCrG?&k1g?iAU3E8ag"])then return end;
getgenv()["DS=yp*:$Ak5Nz5fCrG?&k1g?iAU3E8ag"] = true;
