-- "https://raw.githubusercontent.com/1201for/V.G-Hub-Part-3/main/Fly-Race"

if(not game:IsLoaded())then game.Loaded:Wait()end;
if(game.PlaceId~=6679968919 or nil~=getgenv()["whFG:dD;Gv_lvo6KZ`UC3#(%b5ntKD:1"])then return end;
getgenv()["whFG:dD;Gv_lvo6KZ`UC3#(%b5ntKD:1"] = true;
