...
game:GetService("ReplicatedStorage").Remotes.explodeBomb:FireServer(9e9,game:GetService("Players").LocalPlayer.Backpack.Bomb.Stats,Vector3.new(v.Character.HumanoidRootPart.CFrame.p))
elseif not  game.Players.LocalPlayer.Character:FindFirstChild("Bomb") then
game.Players.LocalPlayer.Character.Humanoid:EquipTool(game:GetService("Players").LocalPlayer.Backpack:WaitForChild("Bomb"))
end end 
local Toggle1 = Section1:CreateToggle("No Cooldown", nil, function(State)
vvv = State
while vvv do
    pcall(function()
    wait()
...
local Toggle1 = Section1:CreateToggle("Anti Explosion", nil, function(State)
to = State
...
local Toggle1 = Section1:CreateToggle("Infinite Coins", nil, function(State)
india = State
while india do
    wait(1)
...
local Toggle1 = Section1:CreateToggle("infinite Levels", nil, function(State)
dodo = State
while dodo do
    wait()
    game:GetService("ReplicatedStorage").Remotes.generateBoost:FireServer("Levels", 480, 1)
end
end) 
