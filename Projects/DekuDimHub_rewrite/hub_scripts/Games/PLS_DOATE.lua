-- "https://raw.githubusercontent.com/1201for/V.G-Hub-Part-3/main/PLS_DOATE"

if(not game:IsLoaded())then game.Loaded:Wait()end;
if(game.PlaceId~=8737602449 or nil~=getgenv()["UAW[?v);Pqi;]Nh%%CtxoLrLVmm?wZ^n"])then return end;
getgenv()["UAW[?v);Pqi;]Nh%%CtxoLrLVmm?wZ^n"] = true;
...
local Tab1 = Window:CreateTab("PLSDONATE")
...
spawn(function()
while Settings.RainBow do pcall(function()
    wait()
...
local Toggle1 = Section1:CreateToggle("Never Gonna Give You Up", Settings.NeverGonna, function(State)
...
while Settings.NeverGonna do pcall(function()
    ...
    require(game.ReplicatedStorage.Remotes).Event("SetBoothText"):FireServer(v, "booth") wait(3.5)
    end 
    end 
    end)
end
