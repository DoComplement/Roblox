-- "https://raw.githubusercontent.com/1201for/V.G-Hub/main/Blox-Fruit"

if(not game:IsLoaded())then game.Loaded:Wait()end;
if(game.PlaceId~=2753915549 or nil~=getgenv()["QzbKAZ5@LV#Vi0v:0QDBu5NTp^2C9gO)"])then return end;
getgenv()["QzbKAZ5@LV#Vi0v:0QDBu5NTp^2C9gO)"] = true;
