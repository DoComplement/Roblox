-- "https://raw.githubusercontent.com/1201for/V.G-Hub-Part-3/main/Pls-CapTure"

if(not game:IsLoaded())then game.Loaded:Wait()end;
if(game.PlaceId~=10859465529 or nil~=getgenv()["y_D3Z7A8LVt!E.Blv6tV$;T69p2msTET"])then return end;
getgenv()["y_D3Z7A8LVt!E.Blv6tV$;T69p2msTET"] = true;
             ...
             then
                ...
                if
                 ...
                 then
                    ...
                    if Distance <= (Settings.Aimbot.FOV or 250)  then
                        Closest = Distance
                        Target = v
                    end
                end
    ...
    function()
        pcall(
            function()
                ...
                mousemoverel(
                (TargetPos.X - Mouse.X) * (Settings.Smoothness or 0.2),
                (TargetPos.Y - Mouse.Y) * (Settings.Smoothness or 0.2)
                )
                end 
            end
        )
...
local Tab1 = Window:CreateTab(game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name)
...
local Dropdown1 = Section1:CreateDropdown("HitPart", {"HumanoidRootPart","Head","Random"}, function(String)
...
local Slider2 = Section1:CreateSlider("Aimbot Smoothness", 0,1,nil,false, function(Value)
